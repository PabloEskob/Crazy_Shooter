// Recompile at 13.02.2023 16:38:43
...
namespace PixelCrushers
{
    ...
    public class LocalizeUI : MonoBehaviour
    {
        ...
        public virtual void UpdateText()
        {
            ...
            var localizedFont = localizedFonts.GetFont(language);
...
#if TMP_PRESENT
            var localizedTextMeshProFont = localizedFonts.GetTextMeshProFont(language);
            if (!m_lookedForTMP)
            {
                m_lookedForTMP = true;
            ...
            if (textMeshPro != null)
            {
                ...
                else
                {
                    ...
                    if (localizedFont != null) textMeshPro.font = localizedTextMeshProFont;
                }
            }
            if (textMeshProUGUI != null)
            {
                ...
                else
                {
                    ...
                    if (localizedFont != null) textMeshProUGUI.font = localizedTextMeshProFont;
                }
            }
#endif
