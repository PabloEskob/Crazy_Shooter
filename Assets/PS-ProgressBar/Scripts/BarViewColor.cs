...
namespace PlayfulSystems.ProgressBar
{
    ...
    public class BarViewColor : ProgressBarProView
    {
        ...
        [Tooltip("Change color of the bar automatically based on it's value.")] [SerializeField]
        bool useGradient;
        ...
        [Header("Color Animation")] [SerializeField]
        bool flashOnGain;
        ...
        Color GetCurrentColor(float percentage)
        {
            if (flashcolorAlpha >= 1f)
                ...
                return Color.Lerp(useGradient ? barGradient.Evaluate(percentage) : defaultColor, flashColor,
                    flashcolorAlpha);
        }
    }
}